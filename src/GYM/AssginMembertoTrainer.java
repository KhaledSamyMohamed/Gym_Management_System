...
public class AssginMembertoTrainer extends javax.swing.JFrame {
    ...
    {
        if(TrainerID.getText().isEmpty())
        {
            JOptionPane.showMessageDialog(null,"Please Enter Trainer ID ");
            return false;
        }
    ...
    private void AssginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AssginBtnActionPerformed
        ...
        //IDOfMember=MemberID.getText();
        //IDOfTrainer=TrainerID.getText();
        
        int TrainersSize=Trainer.NumberOfTrainers;
        int MemberSize=Member.numberofmembers;
